...
<head>
    <meta charset="UTF-8">
    <title>Sistem Informasi Akademik SMA An-Nur</title>
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="https://tse4.mm.bing.net/th?id=OIP.6LkX1AvI7UuOk_vrRbO_zwAAAA&pid=Api&P=0"
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-header bg-primary">
                        ...
                        <p>
                            {{ Auth::user()->name }}
                            <small>Akun sejak {{ Auth::user()->created_at->format('M. Y') }}</small>
                        </p>
                    </li>
                    <!-- Menu Footer-->
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        <div class="float-right d-none d-sm-block">
            <b>Tahun Ajaran</b> 2019-2020
        </div>
        <strong>
           Copyright &copy; 1989 <a href="https://www.smasannur.sch.id/">SMA An-Nur Bululawang</a>.
        </strong>
        All rights reserved.
    </footer>
</div>
